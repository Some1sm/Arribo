...
class ReportCacheService {
  ...
  async generateAndSaveReport(hours = 24, allLinesCatalog = []) {
    ...
    try {
      ...
      return this.cachedReports.get(failKey) || { summary: {}, hourlyDelays: [], peakHours: [], rankingMostDelayed: [], rankingBestPunctuality: [], rankingWorstStops: [], allStopDelays: [], agencyStats: [] };
    }
  }
